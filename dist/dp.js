...
module.exports = {
  ...
  ru: {
    monthNames: ['января', 'февраль', 'Март', 'Aпреля', 'мая', 'июнь', 'июль', 'август', 'сентябрь', 'октября', 'ноября', 'декабрь'],
    shortMonthNames: ['янв', 'фев', 'Мар', 'Aпр', 'мая', 'июн', 'июл', 'авг', 'сен', 'окт', 'ноя', 'дек'],
